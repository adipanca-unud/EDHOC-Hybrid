 ...
 *
 * Outputs the same 3 CSV files (to output_socket/ directory) with identical
...
#ifndef EDHOC_BENCHMARK_SOCKET_H
#define EDHOC_BENCHMARK_SOCKET_H
...
#define SOCK_BENCH_OUTPUT_DIR   "output_socket"
...
#endif /* EDHOC_BENCHMARK_SOCKET_H */
